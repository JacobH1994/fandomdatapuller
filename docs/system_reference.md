...
| `steam_release_history` | 6,967+ (rising) | Track A backfill actively running in the background as this snapshot is taken — expected to take 1-2 weeks of intermittent progress across the full ~185,000-app catalog. Covered by `data/reference/steam_release_history.jsonl` |
